...
class VisionsControllerTest < ActionController::TestCase
  ...
  test "should create vision" do
    assert_difference('Vision.count') do
      post :create, vision: { description: @vision.description, location: @vision.location, title: @vision.title }
    end
  ...
  test "should update vision" do
    patch :update, id: @vision, vision: { description: @vision.description, location: @vision.location, title: @vision.title }
    assert_redirected_to vision_path(assigns(:vision))
  end
